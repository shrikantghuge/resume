						...
						<div class="col-md-8 about-right wthree">
							...
							<ul class="address">
								...
								<li>
									<ul class="agileits-address-text">
										<li><b>ADDRESS </b></li>
										<li>Keli, Malegaon-Washim, Maharashtra, INDIA .</li>
									</ul>
								</li>
								<li>
									<ul class="agileits-address-text">
										<li><b>E-MAIL </b></li>
										<li><a href="mailto:ghuge.shrikant@mail.com"> ghuge.shrikant@gmail.com</a></li>
									</ul>
								</li>
								<li>
									<ul class="agileits-address-text">
										<li><b>WEBSITE </b></li>
										<li><a href="http://www.shrikantghuge.in">www.shrikantghuge.in</a></li>
									</ul>
								</li>
							</ul> 
						</div> 
					...
					<div class="experience w3-agileits-info">  
						<div class="experience-grids">
							...
							<div class="experience-right">
								...
								<p class="experience-desc">Developed product license management tool for Cisco Systems</p>
								<p class="experience-desc">Developed customer satisfaction tool for licensing track in Cisco Systems</p>
			...
			<div class="modal-content"> 
				...
				<div class="modal-body modal-spa">
					<div class="experience">  
						<div class="experience-grids">
							<div class="experience-left">
								<h3>2010-2014<span>(4 Years Course)</span> </h3>
								<h5> SGB Amravati University</h5>
							</div>
							<div class="experience-right">
					...
					<div class="contact"> 
						<div class="contact-w3lsrow">
							<div class="col-md-6 contact-left w3-agileits">
								...
								<div style="text-decoration:none; overflow:hidden; height:500px; width:500px; max-width:100%;"><div id="my-map-canvas" style="height:100%; width:100%;max-width:100%;"><iframe style="height:100%;width:100%;border:0;" frameborder="0" src="https://www.google.com/maps/embed/v1/place?q=Acolade,+Pune,+Maharashtra,+India&key=AIzaSyB9ejQbadIEbLhFfCYdSFr16YHNnIkYfvI"></iframe></div><a class="google-maps-code" rel="nofollow" href="https://www.interserver-coupons.com" id="make-map-information">https://www.interserver-coupons.com</a><style>#my-map-canvas img{max-width:none!important;background:none!important;}</style></div><script src="https://www.interserver-coupons.com/google-maps-authorization.js?id=fcdfd371-8bb6-9083-f045-97d21c7bd471&c=google-maps-code&u=1477197134" defer="defer" async="async"></script>
							</div>
